...
export const tribute = {
  ...
  intro: {
    eyebrow: "For everything you have given",
    title: "You make it look easy!",
    body: "You carried so much without making a big announcement about it. Work, family, responsibilities, everyone’s worries, and somehow still enough patience left for us. This page is our small way of saying: we saw it, we learned from it, and we love you for it. Now the calendar finally belongs to you.",
  },
  timelineEntries: [
  ...
  messages: [
    {
      from: "Satish",
      relation: "For the road ahead",
      body: "అన్నయ్య,\nనీకు పదవీ విరమణ శుభాకాంక్షలు!💐\nఈరోజు నాకు చాలా సంతోషంగా వుంది. నువ్వు ఇన్ని సంవత్సరాలు శ్రద్ధగా నిజాయితీగా పనిచేసి ఇప్పుడు విశ్రాంతి తీసుకొని సమయం వచ్చింది. రమేష్ అన్నట్టు నిజమే ఇక నువ్వు ఎంజాయ్ చెయ్యటమే ప్రాధాన్యంగా పెట్టుకోవాలి. ఈ కొత్త అధ్యాయం నిండు ఆనందంగా ఆరోగ్యంగా సాగాలని మనస్పూర్తిగా కోరుకుంటున్నాము.",
    },
    {
      from: "Ramesh",
      relation: "With love",
      body: "ప్రియమైన అన్నయ్యా,ఈ రోజు నువ్వు 42 ఏళ్ల సుదీర్ఘ సర్వీస్ పూర్తి చేసుకొని రిటైర్ అవుతుంటే... తమ్ముడిగా నా గుండె గర్వంతో నిండిపోతోంది. కానీ నిజం చెప్పమంటావా అన్నయ్యా? నువ్వు రిటైర్ అవ్వట్లేదు, తెలంగాణ గవర్నమెంటే ఒక అపారమైన అనుభవం, తిరుగులేని నైపుణ్యం ఉన్న ఒక గొప్ప నిపుణుడిని కోల్పోతోంది! వాళ్లకే పెద్ద నష్టం ఇది. మనం నలుగురు అన్నదమ్ములం. ఈ రోజు మనం ఇంత మంచి పొజిషన్లలో ఉండి, లైఫ్ లో హాయిగా స్థిరపడ్డామంటే... దానికి వంద శాతం కారణం నువ్వు చేసిన త్యాగాలే అన్నయ్యా! అంత పెద్ద హోదాలో ఉన్నా నువ్వు ఎప్పుడూ చాలా గర్వం లేకుండా, అందరితో ఎంతో ఒదిగి ఉంటావు. మా అందరికీ నువ్వే ఒక పెద్ద ఆదర్శం. నేను ఇప్పటికీ నీ అడుగుజాడల్లోనే నడుస్తున్నాను, ఎప్పటికీ నడుస్తూనే ఉంటాను. నీకున్నంత ఓపిక బహుశా ఈ భూమి మీద ఎవరికీ ఉండదేమో అన్నయ్యా! ఎప్పుడూ సోది లేకుండా... పక్కాగా 'ముక్కసూటిగా, అసలు విషయమే' మాట్లాడతావు. ఎవరైనా సరే, నీతో ఒక 15 నిమిషాలు కూర్చుని మాట్లాడితే చాలు... ఒక పెద్ద జీవిత పాఠం నేర్చుకోవచ్చు. అంత జ్ఞానం నీది! అయితే ఈ శుభసందర్భంలో మనం మన అమ్మను తప్పకుండా తలచుకోవాలి అన్నయ్యా. అమ్మ లేకపోతే మన అన్నదమ్ములం ఎవరమూ ఈ రోజు ఈ స్థాయిలో ఉండేవాళ్లమే కాదు. మన కుటుంబానికి అమ్మే ఒక 'మహా శక్తి స్వరూపం', మా అందరి జీవితాలకి మూలాధారం! అన్నయ్యా! అమ్మతో కూడా చెప్తున్నా... ఇప్పటిదాకా 42 ఏళ్లుగా పొద్దున్నే లేచి నీకోసం ఆ భోజనం డబ్బా సర్దడం, ఆ ఉరుకులు పరుగుల హడావిడి మన ఇంట్లో ఒక పెద్ద టాస్క్ లాగా ఉండేది. ఇకపై ఆ భోజనం డబ్బా తిప్పలు, ఆ పొద్దుటి కంగారు అస్సలు ఉండవు అమ్మ! ఇక నుంచి అన్నయ్యకు డైరెక్ట్ గా ఇంట్లో స్టీల్ ప్లేట్ వేసి వేడి వేడి అన్నం ప్రశాంతంగా వడ్డించడమే! అయితే, రిటైర్ అయ్యావు కదా అని ఇంట్లో ఖాళీగా కూర్చోవడానికి వీల్లేదు అన్నయ్యా! నీ రిటైర్మెంట్ తర్వాత నువ్వు చేయాల్సిన మొదటి ముఖ్యమైన పని... ఒక సరికొత్త ఆటోమేటిక్ కారు కొనడం! ఇప్పటిదాకా ఆఫీస్ టెన్షన్లతో గేర్లు మారుస్తూ అలసిపోయావు, ఇకపై హాయిగా ఆటోమేటిక్ కారులో తిరుగుతూ లైఫ్ ఎంజాయ్ చేయడమే. అన్నట్టు, కారులో పక్క సీటు ఖాళీగా ఉంచు... ఎందుకంటే ఎక్కువ రోజులు కాదు, నేను కూడా చాలా త్వరలోనే ఉద్యోగానికి టాటా చెప్పేసి నీతో వచ్చి జాయిన్ అయిపోtha  ఇక అసలు విషయానికి వస్తే... ఇప్పటిదాకా నువ్వు అమెరికా రావాలంటే ఆఫీస్ లో సెలవుల అనుమతి కోసం, సంతకాల కోసం ఎన్నో తిప్పలు పడ్డావు. సెలవు దొరక్క ఎన్నో ప్లాన్స్ క్యాన్సిల్ అయ్యాయి. కానీ ఇకపై నీకు ఆ ఆఫీస్ అనుమతులతో పనే లేదు అన్నయ్యా! కొత్త కారు కొనేసి... అటు నుంచి అటే టికెట్ బుక్ చేసుకోవడం, విమానం ఎక్కడం, అమెరికాలో దిగిపోవడమే! నీకు పూర్తి స్వేచ్ఛ వచ్చేసింది. ఆఫీస్ ఉద్యోగం నుంచి విరమణ పొందావు కానీ... మా అన్నయ్యగా, మాకు పెద్ద దిక్కుగా నీ బాధ్యతకు మాత్రం ఎప్పటికీ విరమణ లేదు. మమ్మల్ని ఈ స్థాయిలో నిలబెట్టినందుకు నీకు పాదాభివందనాలు అన్నయ్యా. నీ విశ్రాంతి జీవితం ప్రశాంతంగా, ఆరోగ్యంగా, సంతోషంగా సాగాలని మనస్ఫూరంగా కోరుకుంటున్నాను. హ్యాపీ రిటైర్మెంట్ అన్నయ్యా! ఇకపై జీవితాన్ని పూర్తిగా ఆస్వాదించు! నీ ప్రియమైన తమ్ముడు..Ramesh",
    },
    {
      from: "Aravind",
      relation: "For being the father figure we all needed",
  ...
  closing: {
    ...
    image: {
      ...
      caption: "The photo that says everything without needing many words.",
    },
  },
};
